  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="glass-card p-8" style={{ boxShadow: '0 0 40px rgba(212,175,55,0.1)' }}>
          <div className="text-center mb-8">
            <div className="text-4xl mb-3">🎬</div>
            <h1 className="cinzel font-bold text-2xl gold-text">YOKO AJANS</h1>
            <p className="text-gray-400 text-sm mt-1">{t('auth.registerTitle')}</p>
          </div>
          ...
          <p className="text-center text-xs text-gray-500 mt-6">
            {t('auth.hasAccount')}{' '}
            <Link to="/login" className="text-gold-DEFAULT hover:underline">{t('auth.login')}</Link>
          </p>
        </div>
      </div>
    </div>
